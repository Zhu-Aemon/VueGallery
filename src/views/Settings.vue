	...
	<div class="mt-20 ml-20 mr-20 mb-28">
		<div>
			...
			<div class="w-full mt-2 inline-block bg-gray-100 rounded-xl py-2 px-6">
				...
				<div class="inline-block bg-blue-100 rounded-xl py-1 px-2 font-bold select-none cursor-pointer ml-4">
					{{qualityChineseList[qualityList.indexOf(currentQualitySetting)]}}
				</div>
			</div>
